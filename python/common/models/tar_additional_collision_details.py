...
class TarAdditionalCollisionDetails(db.Model):
    ...
    collision_case_num = db.Column(db.String(10), db.ForeignKey('collision.collision_case_num'), primary_key=True)
    ...
    prop_damage_est_value = db.Column(db.Decimal(12, 2))
    ...
    total_est_damage = db.Column(db.Decimal(12, 2), nullable=False, default=0)
