...
class TarEntityVehicle(db.Model):
    ...
    estimated_vehicle_damage = db.Column(db.Decimal(16, 2))
    ...
    pre_collision_vehicle_action_first_event = db.Column(db.String(2), db.ForeignKey('tar_pre_coltar_pre_collision_action.code'))
