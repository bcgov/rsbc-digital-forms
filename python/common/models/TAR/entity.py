...
class TarEntity(db.Model):
    ...
    license_prov_state = db.Column(db.String(5))
    ...
    vehicle_plate_prov_state = db.Column(db.String(5))
    ...
    trailer_towed_plate_prov_state = db.Column(db.String(5))
    ...
    damage_location_code = db.Column(db.String(2), db.ForeignKey('TAR.damage_location.code'), nullable=True)
    severety_code = db.Column(db.String(2), db.ForeignKey('TAR.damage_severity.code'), nullable=True)
