...
class TarInvolvedPerson(db.Model):
    ...
    position_of_person = db.Column(db.String(2), nullable=True)
    safety_equipment_used = db.Column(db.String(2), nullable=True)
    ejection_from_vehicle = db.Column(db.String(2), db.ForeignKey('TAR.ejection.code'), nullable=True)
    age = db.Column(db.String(10), nullable=True)
    sex = db.Column(db.String(1), nullable=True)
    severe_injury_location = db.Column(db.String(2), db.ForeignKey('TAR.injury_location.code'), nullable=True)
    injury_type = db.Column(db.String(2), db.ForeignKey('TAR.injury_type.code'), nullable=True)
