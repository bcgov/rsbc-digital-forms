...
class TarInvolvedPerson(db.Model):
    ...
    position_of_person = db.Column(db.String(2), db.ForeignKey('TAR.position.code'), nullable=False)
    safety_equipment_used = db.Column(db.String(2), db.ForeignKey('TAR.safety_equipment.code'), nullable=False)
