...
class IRPForm(db.Model):
    ...
    time_of_suspicion = db.Column(db.String(5), nullable=False)
    time_of_asd = db.Column(db.String(5), nullable=False)
    refused_or_fail = db.Column(db.String(5), nullable=False)
    ...
    continuous_observation = db.Column(db.String(5), nullable=False)
