...
def contravention():
    if request.method == 'POST':
        ...
        try:
            # contravention = _load_json_into_dict('python/icbc_mock_svc/data/contravention.json')
            contravention = {
                "contraventionId": "123"
            }
            return make_response(jsonify(contravention), 200)
        except Exception as e:
            return make_response(jsonify({
                    "error": {
                        "code": 500,
