...
const city_values = [
  ...
  const trafficIncidentSentences = [
    "The driver's brake lights illuminated promptly upon deceleration.",
    "Vehicle's rearview mirror was adjusted to minimize blind spots.",
    "Passenger's seatbelt clicked securely into place.",
    "Driver's turn signal engaged with a reassuring click.",
    "The vehicle's tires exhibited even wear patterns.",
    "Passenger's side window remained closed during transit.",
    "Driver's hands gripped the steering wheel at the recommended '10 and 2' positions.",
    "Vehicle's license plate was free of dirt or obstruction.",
    "Passenger's posture indicated alertness and attentiveness.",
    "Driver's rearview mirror reflected a clear view of the road behind.",
    "Vehicle's windshield wipers operated smoothly during light rain.",
    "Passenger's phone remained stowed away during the drive.",
    "Driver's side mirror provided adequate visibility of adjacent lanes.",
    "Vehicle's fuel gauge hovered comfortably above the 'E' mark.",
    "Passenger's seat was adjusted to a comfortable position.",
    "Driver's seatbelt strap lay flat across the shoulder and chest.",
    "Vehicle's air conditioning vents were directed away from the face.",
    "Passenger's sunglasses were neatly stored in the overhead compartment.",
    "Driver's vehicle registration was readily accessible in the glove compartment.",
    "Vehicle's horn emitted a standard, non-distracting sound.",
    "Passenger's footwear was appropriate for driving (no flip-flops).",
    "Driver's rear license plate was securely fastened with all screws intact.",
    "Vehicle's dashboard displayed no warning lights or indicators.",
    "Passenger's hands remained clear of the gear shift area.",
    "Driver's rearview mirror was free of smudges or debris.",
    "Vehicle's side mirrors were properly aligned for optimal visibility.",
    "Passenger's attention remained focused on the road ahead.",
    "Driver's sun visor was positioned to block glare from the sun.",
    "Vehicle's radio volume was set at a moderate level.",
    "Passenger's seat headrest was adjusted to the correct height.",
    "Driver's foot was observed to move smoothly between pedals.",
    "Vehicle's headlights were functioning and properly aligned.",
    "Passenger's seatbelt was fastened before the vehicle moved.",
    "Driver's eyes were observed to check mirrors regularly.",
    "Vehicle's brake lights were bright and clearly visible.",
    "Passenger's belongings were securely stowed during transit.",
    "Driver's hands remained on the wheel at all times.",
    "Vehicle's turn signals were used correctly and timely.",
    "Passenger's seat was in an upright position during transit.",
    "Driver's windshield was clean and provided clear visibility.",
    "Vehicle's tire pressure appeared to be within normal range.",
    "Passenger's window was closed to minimize wind noise.",
    "Driver's side window was clear and unobstructed.",
    "Vehicle's rearview mirrors were clean and unscratched.",
    "Passenger's seatbelt was properly adjusted for height and weight.",
    "Driver's dashboard was free of unnecessary items or distractions.",
    "Vehicle's exhaust did not emit excessive smoke.",
    "Passenger's airbag indicator showed normal status.",
    "Driver's vehicle was observed to maintain a safe following distance.",
    "Vehicle's speed was consistent with the flow of traffic.",
    "Passenger's door was securely closed before moving.",
    "Driver's vehicle was observed to stop completely at stop signs.",
    "Vehicle's hazard lights were functional and clearly visible.",
    "Passenger's seatbelt was not twisted or tangled.",
    "Driver's vehicle was observed to yield to pedestrians.",
    "Vehicle's rear windshield was clean and unobstructed.",
    "Passenger's side mirror was properly adjusted for visibility.",
    "Driver's vehicle was observed to signal before changing lanes.",
    "Vehicle's interior lights were not overly bright or distracting.",
    "Passenger's seat was not reclined excessively during transit.",
    "Driver's vehicle was observed to maintain a steady speed on hills.",
    "Vehicle's windshield wipers were in good condition and functional.",
    "Passenger's seatbelt was unfastened only after the vehicle stopped.",
    "Driver's vehicle was observed to navigate turns smoothly.",
    "Vehicle's horn was used appropriately and sparingly.",
    "Passenger's side door was securely closed before moving.",
    "Driver's vehicle was observed to park within designated spaces.",
    "Vehicle's rearview mirror was properly adjusted for visibility.",
    "Passenger's seat was free of loose items during transit.",
    "Driver's vehicle was observed to obey traffic signals.",
    "Vehicle's brake lights were not overly bright or distracting.",
    "Passenger's side window was clean and unobstructed.",
    "Driver's vehicle was observed to use headlights when necessary.",
    "Vehicle's turn signals were bright and clearly visible.",
    "Passenger's seatbelt was fastened securely and properly.",
    "Driver's vehicle was observed to maintain lane discipline.",
    "Vehicle's headlights were not overly bright or blinding.",
    "Passenger's belongings were not obstructing the driver's view.",
    "Driver's vehicle was observed to give way to emergency vehicles.",
    "Vehicle's tire treads appeared to be within safe limits.",
    "The road was wet due to recent rain.",
    "Visibility was reduced due to fog.",
    "The weather was clear and sunny.",
    "There were patches of ice on the road.",
    "The road was dry and visibility was good.",
    "There was a strong wind blowing debris onto the road.",
    "The road was slippery due to oil spill.",
    "The weather was cloudy but visibility was good.",
    "There were potholes on the road due to recent construction.",
    "The road was flooded due to heavy rain.",
    "The weather was hot causing mirages on the road.",
    "There was a snowstorm reducing visibility.",
    "The road was clear of any obstructions.",
    "The weather was humid but didn't affect driving conditions.",
    "There was a landslide blocking part of the road.",
    "The weather was cold causing frost on the road.",
    "The road was uneven due to ongoing construction.",
    "The weather was mild with no impact on visibility.",
    "There was a fallen tree on the road.",
    "The weather was cool and the road was clear.",
    "The road was covered with leaves due to recent winds.",
    "The weather was warm with clear skies.",
    "There was a traffic jam due to an accident ahead.",
    "The weather was rainy causing slippery roads.",
    "The road was blocked due to a parade.",
    "The weather was windy but the road was clear.",
    "There was a detour due to road repair.",
    "The weather was foggy causing reduced visibility.",
    "The road was congested due to peak hour traffic.",
    "The weather was sunny and the road was dry."
  ];
