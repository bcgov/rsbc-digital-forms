...
export const StaticData = () => {
  ...
  const setVehicleMakesResource = useSetRecoilState(
    staticResources["vehicle_makes"]
  );
  const setVehicleModelsResource = useSetRecoilState(
  ...
  const handleStaticDataPull = () => {
    ...
    const vehicleMakesData = StaticDataApi.get("vehicle_makes").data;
    const vehicleModelsData = StaticDataApi.get("vehicle_models").data;

    setVehicleMakesResource(vehicleMakesData);
    setVehicleModelsResource(vehicleModelsData);
