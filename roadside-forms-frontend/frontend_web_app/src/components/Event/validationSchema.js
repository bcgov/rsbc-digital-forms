...
export const validationSchema = Yup.object().shape({
  ...
  "ILO-name": Yup.string().when(["TwentyFourHour", "VI", "vehicle_impounded"], {
  ...
  "ILO-city": Yup.string().when(["TwentyFourHour", "VI", "vehicle_impounded"], {
    is: (TwentyFourHour, VI, vehicle_impounded) => {
      return (TwentyFourHour || VI) && vehicle_impounded === "YES";
    },
    then: () => {
  ...
  agency_file_no: Yup.string().when(["TwentyFourHour", "TwelveHour", "VI"], {
    is: (TwentyFourHour, TwelveHour, VI) => TwentyFourHour || TwelveHour || VI,
  ...
  /** Incident Details */
  incident_details_extra_page: Yup.boolean().when(["VI", "incident_details"], {
